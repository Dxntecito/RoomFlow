document.addEventListener("DOMContentLoaded", () => {
    ...
    function validarEvento() {
        const campos = ["evento-fecha", "evento-hora-entrada", "evento-hora-salida", "capacidad"];
    ...
    btnPagar.addEventListener("click", async (e) => {
        ...
        const serviciosSeleccionados = [...document.querySelectorAll(".card-servicio input:checked")].map(chk => {
            return {
                id: chk.dataset.id,
